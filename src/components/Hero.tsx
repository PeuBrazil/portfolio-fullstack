export function Hero() {
  return (
    <section className="space-y-6 pt-12 max-w-3xl">
      <p className="font-mono text-xs font-semibold tracking-widest text-purple-400 uppercase">Olá, o meu nome é</p>
      ...
      <h2 className="text-xl sm:text-2xl font-medium text-zinc-400">
        Desenvolvedor Full Stack Júnior especializado em React, PHP e Laravel.
      </h2>
