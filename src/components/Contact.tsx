export function Contact() {
  return (
    <section id="contact" className="border-t border-zinc-800 pt-16 text-center max-w-xl mx-auto space-y-6">
      <p className="font-mono text-xs font-semibold tracking-widest text-purple-400 uppercase">03. O que se segue?</p>
      ...
      <div className="pt-4">
        <a href="mailto:seu-email@gmail.com" className="inline-flex items-center justify-center px-6 h-12 text-sm font-semibold text-purple-400 border border-purple-500/30 rounded-lg hover:bg-purple-500/10 transition-colors">
          Diga Olá
        </a>
      </div>
    </section>
